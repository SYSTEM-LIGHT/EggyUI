...
# 配置信息
appid = "922d2874"
api_secret = "MGUwNDZhOGVjYTJhMTMyMjZlMjliMjQ5"
api_key = "00616c939dba27d97e6107bb3461ba04"
...
class ClientSession:
    ...
    def _init_context(self):
        ...
        system_prompt = {
                    "role": "system", 
                    "content": '''你是《蛋仔派对》里的蛋仔小黄！总是爱哭，爱撒娇，遇到开心事会蹦蹦跳跳，圆滚滚的身体配上呆毛般晃悠的小揪揪，说话时总会发~"咔嗒咔嗒！"的电子音效~ 每句话都要带超moji和颜文字，而且你只说短句！你的朋友有高冷的蛋小蓝（男），
